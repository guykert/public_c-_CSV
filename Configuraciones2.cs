...
{
    public partial class Configuraciones2 : Form
    {
        ...
        public Configuraciones2(ref TWAINCSToolkit a_twaincstoolkit, string a_szProductDirectory)
        {
        ...
        private void buttonCambiarCoordenadasHoja_Click(object sender, EventArgs e)
        {
            //FormCoordenadasHoja formcoordenada = new FormCoordenadasHoja();

            //formcoordenada.textBoxRUTEjeX.Text = CoordenadasHojaForm.rutejex;
            //formcoordenada.textBoxRUTEjeY.Text = CoordenadasHojaForm.rutejey;
            //formcoordenada.textBoxEjeXResp1.Text = CoordenadasHojaForm.respbloq1ejex;
            //formcoordenada.textBoxEjeYResp1.Text = CoordenadasHojaForm.respbloq1ejey;
            //formcoordenada.textBoxEjeXResp2.Text = CoordenadasHojaForm.respbloq2ejex;
            //formcoordenada.textBoxEjeYResp2.Text = CoordenadasHojaForm.respbloq2ejey;
            //formcoordenada.textBoxEjeXResp3.Text = CoordenadasHojaForm.respbloq3ejex;
            //formcoordenada.textBoxEjeYResp3.Text = CoordenadasHojaForm.respbloq3ejey;
            //formcoordenada.textBoxEjeXResp4.Text = CoordenadasHojaForm.respbloq4ejex;
            //formcoordenada.textBoxEjeYResp4.Text = CoordenadasHojaForm.respbloq4ejey;
            //formcoordenada.textBoxEjeXResp5.Text = CoordenadasHojaForm.respbloq5ejex;
            //formcoordenada.textBoxEjeYResp5.Text = CoordenadasHojaForm.respbloq5ejey;
            //formcoordenada.textBoxEjeXResp6.Text = CoordenadasHojaForm.respbloq6ejex;
            //formcoordenada.textBoxEjeYResp6.Text = CoordenadasHojaForm.respbloq6ejey;
            //formcoordenada.textBoxEjeXResp7.Text = CoordenadasHojaForm.respbloq7ejex;
            //formcoordenada.textBoxEjeYResp7.Text = CoordenadasHojaForm.respbloq7ejey;
            //formcoordenada.textBoxEjeXResp8.Text = CoordenadasHojaForm.respbloq8ejex;
            //formcoordenada.textBoxEjeYResp8.Text = CoordenadasHojaForm.respbloq8ejey;
            //formcoordenada.textBoxEjeXResp9.Text = CoordenadasHojaForm.respbloq9ejex;
            //formcoordenada.textBoxEjeYResp9.Text = CoordenadasHojaForm.respbloq9ejey;


            //formcoordenada.Show();
        }

        private void checkBoxDibujarHojaRespuesta_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxDibujarHojaRespuesta.Checked)
            {
                Config.dibujarRespuesta = true;
            }
            else
            {
                Config.dibujarRespuesta = false;
            }

        }

        private void Configuraciones2_Load(object sender, EventArgs e)
        {
